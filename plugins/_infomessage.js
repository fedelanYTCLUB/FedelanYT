...
let redes = `github.com/Brauliovh3`
let adiosbye = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://a.storyblok.com/f/178900/1200x676/b1e0d587bd/gekijouban_project_sekai_kowareta_sekai_to_utaenai_miku_hero.jpg/m/1200x0/filters:quality(95)format(webp)')
let adi = await (await fetch(adiosbye)).buffer()
let ppUrl = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://a.storyblok.com/f/178900/1200x676/b1e0d587bd/gekijouban_project_sekai_kowareta_sekai_to_utaenai_miku_hero.jpg/m/1200x0/filters:quality(95)format(webp)');
